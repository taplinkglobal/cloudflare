...
class ZoneLockdownTest extends TestCase
{
    public function testListLockdowns()
    {
        ...
        $zones = new \Taplink\Cloudflare\Endpoints\ZoneLockdown($mock);
    ...
    {
        $config = new \Taplink\Cloudflare\Configurations\ZoneLockdown();
        ...
        $zoneLockdown = new \Taplink\Cloudflare\Endpoints\ZoneLockdown($mock);
    ...
    public function testGetRecordDetails()
    {
        ...
        $lockdown = new \Taplink\Cloudflare\Endpoints\ZoneLockdown($mock);
